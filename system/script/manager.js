...
Event.observe(window, 'load', function(){										   
	...
	if(url.length == 2){
		...
		updateWindow('helpContent', 'http://www.dimap.ufrn.br/root_logicamente/modules/controller.php', 'helpModule=logicamente');
	}
...
function updateContent(element){
	//content
	updateWindow('content'    , 'http://www.dimap.ufrn.br/root_logicamente/modules/controller.php', 'module='+$(element).id);
	
	//help
	updateWindow('helpContent', 'http://www.dimap.ufrn.br/root_logicamente/modules/controller.php', 'helpModule='+$(element).id);

	//javascript
	upJs('js', 'http://www.dimap.ufrn.br/root_logicamente/modules/controller.php', 'js='+$(element).id);	

	//css
	upCss("css", "http://www.dimap.ufrn.br/root_logicamente/modules/controller.php", "css="+$(element).id);
