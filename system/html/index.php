...
<title> .: Logicamente :. </title>	
	<script src="http://www.dimap.ufrn.br/root_logicamente/libs/validation/scriptaculous/lib/prototype.js"></script>
	<script src="http://www.dimap.ufrn.br/root_logicamente/libs/validation/scriptaculous/src/effects.js"></script>
	<script src="http://www.dimap.ufrn.br/root_logicamente/libs/validation/validation.js"></script>
	<script src="http://www.dimap.ufrn.br/root_logicamente/libs/validation/fabtabulous.js"></script>
	<script src="http://www.dimap.ufrn.br/root_logicamente/libs/jquery.js"></script>
	<script src="http://www.dimap.ufrn.br/root_logicamente/libs/jquery.corner.js"></script>
	<script src="http://www.dimap.ufrn.br/root_logicamente/libs/shortcut.js"></script>
	<script src="http://www.dimap.ufrn.br/root_logicamente/libs/interface.js"></script>
	<script src="http://www.dimap.ufrn.br/root_logicamente/system/script/manager.js"></script>	
	<!-- <script id="js"></script> -->
	
	<link rel="stylesheet" type="text/css" href="http://www.dimap.ufrn.br/root_logicamente/libs/validation/style.css" />
	<link rel="stylesheet" type="text/css" href="" id="css"/>
	<style> 
		@import "http://www.dimap.ufrn.br/root_logicamente/system/css/default.css";
		@import "http://www.dimap.ufrn.br/root_logicamente/system/css/menuItems.css";
		@import "http://www.dimap.ufrn.br/root_logicamente/system/css/resolutionGame.css";
	</style>
