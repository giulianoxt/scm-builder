<fieldset>
    ...
    <div class="form-row">
        <button id="startGame" title="Clique aqui para começar o jogo">Start game</button>
...
<button class="button" id="solveAutomatically" title="Clique aqui para o programa continuar a solu&#231;ão automaticamente">Solve automatically</button>
<button class="button" id="solve" title="Selecione duas cláusulas e clique aqui para fazer a elimina&#231;ão">Do selected elimination</button>
